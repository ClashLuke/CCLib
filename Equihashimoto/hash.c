...
uint64_t equihashimoto_full(uint8_t* hash, uint8_t* dataset, uint64_t difficulty, uint64_t nonce){
	...
	*hash64_6 += nonce; *hash64_7 += nonce;
	while(1){
		*item     = dataset[*hash32_0 ];
		*item_1   = dataset[*hash32_1 ];
		*item_2   = dataset[*hash32_2 ];
		*item_3   = dataset[*hash32_3 ];
		*item_4   = dataset[*hash32_4 ];
		*item_5   = dataset[*hash32_5 ];
		*item_6   = dataset[*hash32_6 ];
		*item_7   = dataset[*hash32_7 ];
		*item_8   = dataset[*hash32_8 ];
		*item_9   = dataset[*hash32_9 ];
		*item_10  = dataset[*hash32_10];
		*item_11  = dataset[*hash32_11];
		*item_12  = dataset[*hash32_12];
...
uint8_t equihashimoto_verify(uint8_t* hash, uint64_t nonce, uint8_t* cache, uint64_t difficulty){
	uint8_t   item[32]  = {0};
	uint8_t   out[32]   = {0};
	uint8_t*  item_1    = &item[1];
	uint8_t*  item_2    = &item[2];
